...
def EngraveLettersDog(laserRobot):
    #Generate G-Code:
    width, height = l_m.gcode_message_creation("DOG",10,False,255,(0,296))
...
def EngraveUnderLine(laserRobot, width, height):
    ...
    #Set laser object center, angle, height/width, laser power:
    line_prop = l_m.Laser_Object_Properties(fixHeight=False,centerPoint=[0,295-height/2],specifiedLength=width,laserPower=255,angle=0)
